      ...
      <div className="bg-white text-gray-900 dark:bg-black dark:text-white">
        ...
        <main className=" w-full">
          ...
          <h1 className="text-center text-2xl mt-10">
            Conheça os membros da nossa{" "}
            <span className="text-[#FF6700]">Equipe</span>
          </h1>
          <Team />
          <h1 className="text-center text-2xl mt-10 p-10">
            História e criação da{" "}
            <span className="text-[#FF6700]">Makamba Tec</span>
          </h1>
